...
public interface ILogger {
    ...
    public final static String TAG_GPS_MAB = "GPS-M";
    public final static String TAG_DSRC_OBU = "DSRC-O";
    public final static String TAG_DSRC_MAB = "DSRC-M";
    public final static String TAG_COMMAND = "CMD";
    public final static String TAG_EXECUTOR = "EXEC";
    public final static String TAG_DVI = "HMI";

    /**
     * Log a message at {@link com.leidos.glidepath.logger.LogEntry.Level#DATA} level.
     *
    ...
    /**
     * Log a message at {@link com.leidos.glidepath.logger.LogEntry.Level#DATA} level. Formats the message much
    ...
    /**
     * Log a message at {@link com.leidos.glidepath.logger.LogEntry.Level#DEBUG} level.
     * @param tag A string representing the category of the data
    ...
    /**
     * Log a message at {@link com.leidos.glidepath.logger.LogEntry.Level#ERROR} level.
     * @param tag A string representing the category of the data
     * @param message A string containing a message to be logged
     * @return A reference to the generated log entry
     */
    ...
    /**
     * Log a message at {@link com.leidos.glidepath.logger.LogEntry.Level#WARN} level.
     * @param tag A string representing the category of the data
     * @param message A string containing a message to be logged
     * @return A reference to the generated log entry
     */
    ...
    /**
     * Log a message at the {@link com.leidos.glidepath.logger.LogEntry.Level#DEBUG} level with formatted messaged. Follows format
    ...
    /**
     * Log a message at the {@link com.leidos.glidepath.logger.LogEntry.Level#WARN} level with formatted messaged. Follows format
     * like C printf() using f_args[] as the format arguments. Any unmatched arguments/placeholders will be discarded
     * and replaced with ''
     * @param tag A string representing the category of the data
     * @param message A string containing a message to be logged
    ...
    /**
     * Log a message at the {@link com.leidos.glidepath.logger.LogEntry.Level#ERROR} level with formatted messaged. Follows format
     * like C printf() using f_args[] as the format arguments. Any unmatched arguments/placeholders will be discarded
     * and replaced with ''
     * @param tag A string representing the category of the data
     * @param message A string containing a message to be logged
    ...
    /**
     * Log a message at the {@link com.leidos.glidepath.logger.LogEntry.Level#INFO} level with formatted messaged. Follows format
     * like C printf() using f_args[] as the format arguments. Any unmatched arguments/placeholders will be discarded
     * and replaced with ''
     * @param tag A string representing the category of the data
     * @param message A string containing a message to be logged
