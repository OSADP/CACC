...
public class Logger implements ILogger {
    ...
    /**
     * Generates and populates the fields of a new {@link com.leidos.glidepath.logger.LogEntry} object. Takes System.getCurrentTimeMillis
    ...
    @Override
    public synchronized void notifyWritten() {
        //empty the unwritten buffer
