...
============================
CACC VISSIM 1.0 Algorithm is designed to simulate close-spaced CACC platoons in VISSIM using the COM interface and VISSIM API.
This application can be used to evaluate the operational benefits of having a dedicated CACC lane on freeway.
Need Visual Studio 2013 and VISSIM version 6.22 (both 32 and 64 bit versions work) to run the algorithm.
...
The CACC VISSIM 1.0 Algorithm can run on most standard Window based computers with 
...
The CACC VISSIM 1.0 Algorithm was developed using C# (VISSIM COM code) and C++ (VISSIM API code).
